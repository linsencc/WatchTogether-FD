...
const Content = () => {
  ...
  useEffect(() => {
    setSocket(io('http://127.0.0.1:5000/room', {
  ...
  }, /*#__PURE__*/React.createElement(Listener, {
    socket: socket,
    video: video,
    roomNumber: 9999
...
const Listener = ({
  ...
  }, /*#__PURE__*/React.createElement("div", null, "\u623F\u95F4\u53F7: ", roomNumber), /*#__PURE__*/React.createElement(Tag, {
    size: "small",
    color: "green",
    type: "solid"
  }, isConnected ? '在线' : '离线'), /*#__PURE__*/React.createElement("div", {
    onClick: initNewSyncState
  }));
};
const RoomPanel = ({
  socket
  ...
  const userToList = () => {
    return Object.keys(users).map(user => {
      ...
      }, /*#__PURE__*/React.createElement(IconRadio, null), " ", /*#__PURE__*/React.createElement("div", {
        style: {
          width: "50px"
        }
